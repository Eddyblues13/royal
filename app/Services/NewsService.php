...
class NewsService
{
    ...
    private function getMockNews($limit = 6)
    {
        $mockNews = [
            [
                'title' => 'Royal Caribbean Investment Hits Record Growth in Q4',
                'description' => 'Royal Caribbean Investment achieved record-breaking growth in Q4 2025, with expanding managed assets and a rapidly growing global community of investors.',
                'url' => '#',
                'source' => 'Market Watch',
