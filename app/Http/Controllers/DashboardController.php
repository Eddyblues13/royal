...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Vehicles owned == completed orders count
        $vehiclesCount = Order::where('user_id', $user?->id)
            ...
            try {
                ...
                Mail::raw(
                    "Hello {$user->name},\n\n" .
                        ...
                        "Best regards,\nRoyal Caribbean Investment Trading Team",
                    function ($message) use ($user) {
                        $message->to($user->email)
                            ->subject('Stock Purchase Confirmation - Royal Caribbean Investment');
                    }
                );
            } catch (\Exception $e) {
    ...
    /**
     * Show the inventory page (vehicles).
     */
