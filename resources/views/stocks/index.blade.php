...
@section('title', 'Stock Markets - Royal Caribbean Investment')
        ...
        <div class="wrap">
            <div class="max-w-3xl">
                ...
                <p class="text-[15px] md:text-[16px] text-white/60">
                    Featured picks, top gainers, losers, and <span class="text-[#2563EB] font-[600]">most active</span> stocks.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#07090c] pb-20">
        <div class="wrap">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                <!-- Featured -->
                <div class="rounded-[18px] border border-white/10 bg-white/5 overflow-hidden hover:border-[#2563EB]/50 transition-colors">
                    <div class="flex items-center justify-between px-5 py-4 text-[13px] font-[900] text-white/75 border-b border-[#2563EB]/20">
                    ...
                    @forelse($featuredStocks ?? [] as $symbol => $stock)
                        <div class="flex items-center justify-between gap-3 px-5 py-4 border-t border-white/7">
                            <div class="flex items-center gap-3 min-w-0">
                                <div class="w-[30px] h-[30px] rounded-[10px] border border-[#2563EB]/30 bg-black/20 grid place-items-center text-[#2563EB] text-[12px] font-[900]">
                                    {{ substr($symbol, 0, 1) }}
                                </div>
                                <div class="min-w-0">
                    ...
                    @forelse($topGainers ?? [] as $stock)
                        <div class="flex items-center justify-between px-5 py-4 border-t border-white/7">
                            <div class="flex items-center gap-3">
                                <div class="w-[30px] h-[30px] rounded-[10px] border border-[#2563EB]/30 bg-black/20 grid place-items-center">
                                    <span class="text-[12px] font-[900] text-[#2563EB]">{{ substr($stock['symbol'] ?? '?', 0, 2) }}</span>
                                </div>
                ...
                <div class="rounded-[18px] border border-white/10 bg-white/5 overflow-hidden hover:border-[#2563EB]/50 transition-colors">
                    ...
                    @forelse($mostActive ?? [] as $stock)
                        ...
                        <div class="flex items-center justify-between px-5 py-4 border-t border-white/7">
                            ...
                            <div class="text-[12px] font-[800] text-[#2563EB]/80">Vol {{ $volumeFormatted }}</div>
                        </div>
                    @empty
                        <div class="px-5 py-4 border-t border-white/7 text-[12px] text-white/50">Loading data...</div>
                    @endforelse
