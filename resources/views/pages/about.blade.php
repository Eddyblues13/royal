...
@section('title', 'About Us - Royal Caribbean Investment')
        ...
        <div class="wrap">
            <div class="max-w-4xl">
                <h1 class="text-[48px] md:text-[64px] font-[900] tracking-[-.04em] text-[#0f1115] mb-4">
                    About Royal Caribbean Investment
                </h1>
            ...
            <div class="max-w-4xl">
                <div class="prose prose-lg max-w-none">
                    ...
                    <p class="text-[15px] text-black/70 leading-relaxed mb-6">
                        Royal Caribbean Investment is an all-in-one platform that combines investment opportunities, stock trading, and premium electric vehicle inventory. We're dedicated to making sustainable investing and transportation accessible to everyone.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div class="p-6 rounded-lg border border-black/10 bg-white">
                            ...
                            <div class="text-[13px] text-black/60">Curated selection of premium vehicles ready for delivery.</div>
                        </div>
                    </div>
