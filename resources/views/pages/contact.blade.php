...
@section('title', 'Contact Us - Royal Caribbean Investment')
                ...
                <div>
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <a href="mailto:support@royalcaribbeaninvestment.com" class="text-[15px] text-[#0f1115] hover:opacity-80 transition">support@royalcaribbeaninvestment.com</a>
                        </div>
                        <div>
