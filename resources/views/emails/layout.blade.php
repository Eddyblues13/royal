...
<head>
    ...
    <title>{{ $title ?? 'Royal Caribbean Investment' }}</title>
    <style>
    ...
    <div class="email-wrapper">
        <div class="email-header">
            <div class="email-logo">
                <img src="{{ url('images/logo.png') }}" alt="Royal Caribbean Investment Logo"
        ...
        <div class="email-footer">
            <p><strong>Royal Caribbean Investment</strong></p>
            ...
            <p style="margin-top: 16px; font-size: 12px; color: #9ca3af;">
                © {{ date('Y') }} Royal Caribbean Investment. All rights reserved.
            </p>
        </div>
    </div>
</body>
