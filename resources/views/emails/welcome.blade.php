...
@section('content')
<h1>Welcome to Royal Caribbean Investment!</h1>

<p>Hello <strong>{{ $user->name }}</strong>,</p>

<p>We're thrilled to have you join The Royal Caribbean Investment platform! Your account has been successfully created and you're all set to start your journey with us.</p>
...
<h2>Get Started</h2>
<p>Here's what you can do on Royal Caribbean Investment:</p>
...
<ul style="margin-left: 20px; margin-bottom: 24px; color: #374151;">
    ...
    <li style="margin-bottom: 8px;"><strong>Browse Vehicle Inventory</strong> - Discover premium vehicles</li>
...
<p>
    <strong>The Royal Caribbean Investment Team</strong>
</p>
@endsection
