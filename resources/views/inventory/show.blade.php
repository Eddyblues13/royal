...
@section('title', $car->name . ' - Royal Caribbean Investment Inventory')
    ...
    <div class="wrap">
        <div class="mb-6">
            <a href="{{ route('inventory') }}"
                class="inline-flex items-center gap-2 text-[13px] font-[700] text-[#2563EB] hover:opacity-80 transition-colors mb-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <div class="mb-8">
                    <div class="text-[28px] font-[900] text-[#2563EB] mb-2">
