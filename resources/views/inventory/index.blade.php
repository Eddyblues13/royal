...
@section('title', 'Inventory - Royal Caribbean Investment')
        ...
        <div class="wrap">
            <div class="max-w-3xl">
                ...
                <p class="text-[15px] md:text-[16px] text-black/60">
                    Explore our curated selection of <span class="text-[#2563EB] font-[600]">premium vehicles</span> ready for delivery.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white pb-20">
        <div class="wrap">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($cars as $car)
                    <div class="rounded-[18px] border border-black/10 bg-white overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.08)] hover:shadow-[0_15px_40px_rgba(227,25,55,0.2)] hover:border-[#2563EB]/50 transition">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('inventory.show', $car) }}" class="flex-1 h-[34px] px-4 rounded-md border border-black/15 bg-white text-[#0f1115] text-[12px] font-[800] hover:bg-black/5 hover:border-[#2563EB]/50 transition inline-flex items-center justify-center">
                                    View Details
                                </a>
                                @auth
                                    <a href="{{ route('inventory.show', $car) }}" class="flex-1 h-[34px] px-4 rounded-md text-white text-[12px] font-[800] hover:opacity-90 transition inline-flex items-center justify-center" style="background: #2563EB;">
                                        Order
                                    </a>
                                @else
                                    <a href="{{ route('login') }}" class="flex-1 h-[34px] px-4 rounded-md text-white text-[12px] font-[800] hover:opacity-90 transition inline-flex items-center justify-center" style="background: #2563EB;">
                                        Order
                                    </a>
                                @endauth
                            </div>
                ...
                @empty
                    <div class="col-span-3 text-center py-16">
                        ...
                        <a href="{{ route('home') }}" class="text-[14px] font-[700] text-[#2563EB] hover:opacity-80 transition-colors">
                            Return to Homepage
                        </a>
                    </div>
                @endforelse
