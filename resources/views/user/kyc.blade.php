...
@section('title', 'Royal Caribbean Investment KYC Verification')
    ...
    <div class="lowerGrid" style="grid-template-columns: 1fr; margin-top: 12px;">
        <div class="whitePanel">
            ...
            <div style="padding: 20px;">
                @if ($errors->any())
                    <div style="padding: 12px; margin-bottom: 16px; border-radius: 10px; background: #dbeafe; border: 1px solid #fecaca;">
                ...
                <form method="POST" action="{{ route('dashboard.kyc.submit') }}" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 24px;">
                    ...
                    <div style="padding-top: 12px; border-top: 1px solid rgba(0,0,0,.06);">
                        <button type="submit" style="height: 42px; padding: 0 24px; border-radius: 10px; background: #2563EB; color: #fff; font-size: 12px; font-weight: 900; border: none; cursor: pointer; transition: all 0.2s; display: inline-flex; align-items: center; gap: 8px;">
