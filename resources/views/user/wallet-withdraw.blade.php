...
@section('title', 'Royal Caribbean Investment Wallet - Withdraw Funds')
...
<div class="wrap" id="wallet-withdraw">
    ...
    <div class="lowerGrid" style="grid-template-columns: 1fr; margin-top: 12px;">
        <div class="walletFormWrap">
            @if ($errors->any())
                <div style="margin-bottom: 12px; padding: 10px 12px; border-radius: 10px; background:#dbeafe; border:1px solid #fecaca; font-size:12px; color:#1e40af;">
