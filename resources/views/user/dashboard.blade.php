...
@section('title', 'Royal Caribbean Investment Dashboard')
        ...
        <div class="heroCard">
            ...
            <div class="balanceBox">
                <div class="balanceTop">
                    ...
                    <span
                        class="inline-flex w-8 h-8 rounded-xl border border-white/10 bg-[#2563EB]/25 items-center justify-center">
    ...
    <div class="lowerGrid">
        ...
        <div class="whitePanel">
            <div class="panelHead">
                <div>
                    <h5>Recent Orders</h5>
                    <small>Your latest vehicle purchases</small>
                </div>
            ...
            <div class="orderRow">
                <div class="orderLeft">
                    ...
                    <div class="min-w-0">
                        <div class="orderTitle">{{ $order->car?->name ?? 'Vehicle' }}</div>
                        <div class="orderMeta">
