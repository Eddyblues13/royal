...
@section('title', 'Royal Caribbean Investment Investment Dashboard')
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.06);">
                                ...
                                <td style="padding: 14px; text-align: center;">
                                    <span style="display: inline-block; padding: 4px 10px; border-radius: 999px; font-size: 10px; font-weight: 900; 
                                        ...
                                        @else
                                            background: rgba(239, 68, 68, .14); color: #1e40af; border: 1px solid rgba(239, 68, 68, .45);
                                        @endif">
                                        {{ $investment->status }}
                                    </span>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" style="padding: 40px 20px; text-align: center;">
                                    ...
                                    <a href="{{ route('dashboard.investments') }}" style="display: inline-block; margin-top: 16px; padding: 8px 16px; border-radius: 8px; background: #2563EB; color: #fff; font-size: 11px; font-weight: 900; text-decoration: none;">
