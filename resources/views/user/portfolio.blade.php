...
@section('title', 'Royal Caribbean Investment Portfolio')
                ...
                <div class="statGrid" style="margin-top: 12px;">
                    ...
                    <div class="stat">
                        ...
                        <div style="padding: 14px;">
                            @if ($errors->any())
                                <div style="padding: 12px; margin-bottom: 12px; border-radius: 10px; background: #dbeafe; border: 1px solid #fecaca;">
                            ...
                            <form method="POST" action="{{ route('dashboard.support.submit') }}" style="display: flex; flex-direction: column; gap: 14px;">
                                ...
                                <button type="submit" style="height: 38px; padding: 0 20px; border-radius: 10px; background: #2563EB; color: #fff; font-size: 12px; font-weight: 900; border: none; cursor: pointer; transition: opacity 0.15s;">
                                    Send Message
                                </button>
                            </form>
                        </div>
                    ...
                    <div class="whitePanel">
                        ...
                        <div style="padding: 14px; display: flex; flex-direction: column; gap: 12px;">
                            ...
                            <div style="padding: 12px; border-radius: 10px; border: 1px solid rgba(0,0,0,.06); background: #f9fafb;">
                                ...
                                <p style="margin: 0; font-size: 11px; color: #6b7280; font-weight: 700;">support@royalcaribbeaninvestment.com</p>
