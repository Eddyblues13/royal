...
@section('title', 'Royal Caribbean Investment Investments')
...
<div class="wrap" id="investments">
    ...
    @if ($errors->any())
        <div class="surface" style="margin-bottom: 12px;">
            <div style="padding: 12px 16px; border-radius: 12px; background:#dbeafe; border:1px solid #fecaca; font-size:12px; color:#1e40af;">
