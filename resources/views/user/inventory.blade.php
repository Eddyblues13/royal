...
@section('title', 'Royal Caribbean Investment Inventory')
...
<div class="wrap" id="inventory">
    ...
    <div class="surface">
        <div class="heroCard">
            <div class="heroText">
                ...
                <p>Browse available premium vehicles and place an order.</p>
            </div>
        </div>
    </div>
    ...
    <!-- Error Messages -->
    @if ($errors->any())
        <div style="padding: 12px; margin: 12px 0; border-radius: 10px; background: #dbeafe; border: 1px solid #fecaca;">
