...
@section('title', 'Portfolio - Royal Caribbean Investment')
        ...
        <div class="wrap">
            <div class="max-w-3xl">
                <h1 class="text-[48px] md:text-[64px] font-[900] tracking-[-.04em] text-white mb-4">
                    Your Portfolio <span class="text-[#2563EB]">•</span>
                </h1>
    ...
    <section class="bg-[#07090c] pb-20">
        <div class="wrap">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div class="glass bigCard hover:border-[#2563EB]/30 transition-colors">
                    <div class="label text-[#2563EB]">Total Value</div>
                    <div class="big"><span class="text-[#2563EB]">$125,430.00</span></div>
                    <div class="desc">+$5,234.50 (+4.35%)</div>
                </div>

                <div class="glass bigCard hover:border-[#2563EB]/30 transition-colors">
                    <div class="label text-[#2563EB]">Invested</div>
                    <div class="big"><span class="text-[#2563EB]">$120,195.50</span></div>
                    <div class="desc">Principal amount</div>
                </div>

                <div class="glass bigCard hover:border-[#2563EB]/30 transition-colors">
                    <div class="label text-[#2563EB]">Returns</div>
                    <div class="big"><span class="text-[#2563EB]">+$5,234.50</span></div>
            ...
            <!-- Holdings -->
            <div class="mb-12">
                <h2 class="text-[28px] font-[900] tracking-[-.02em] text-white mb-6">Holdings <span class="text-[#2563EB]">•</span></h2>
                <div class="glass overflow-hidden hover:border-[#2563EB]/30 transition-colors">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-[#2563EB]/30">
                                    <th class="px-5 py-4 text-left text-[13px] font-[900] text-[#2563EB]">Symbol</th>
                                    <th class="px-5 py-4 text-left text-[13px] font-[900] text-[#2563EB]">Name</th>
                                    <th class="px-5 py-4 text-right text-[13px] font-[900] text-[#2563EB]">Shares</th>
                                    <th class="px-5 py-4 text-right text-[13px] font-[900] text-[#2563EB]">Price</th>
                                    <th class="px-5 py-4 text-right text-[13px] font-[900] text-[#2563EB]">Value</th>
                                    <th class="px-5 py-4 text-right text-[13px] font-[900] text-[#2563EB]">Change</th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="glass bigCardTall hover:border-[#2563EB]/30 transition-colors">
                <div class="label text-[#2563EB]">Performance</div>
                <div class="big">Last 30 Days <span class="text-[#2563EB]">•</span></div>
                <div class="desc">Portfolio value over time</div>
                <div class="mt-6 h-48 bg-black/20 rounded-lg flex items-center justify-center border border-[#2563EB]/20">
                    <div class="text-[#2563EB]/60 text-[13px]">Chart visualization would appear here</div>
                </div>
            </div>
        </div>
    </section>
