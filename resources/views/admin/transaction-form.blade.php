    ...
    <div class="whitePanel" style="max-width: 700px; margin: 0 auto;">
        ...
        <form method="POST" action="{{ isset($transaction) ? route('admin.transactions.update', $transaction) : route('admin.transactions.store') }}" style="padding: 20px;">
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <a href="{{ route('admin.transactions') }}" style="flex: 1; height: 44px; border-radius: 8px; background: #2563EB; color: white; font-size: 13px; font-weight: 900; text-decoration: none; display: flex; align-items: center; justify-content: center;">
                    Cancel
                </a>
            </div>
        </form>
