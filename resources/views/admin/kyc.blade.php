    ...
    <div class="whitePanel" style="margin-bottom: 12px;">
        <form method="GET" action="{{ route('admin.kyc') }}" class="p-4">
            <div style="display: flex; gap: 12px; align-items: end;">
                ...
                @if(request('status'))
                    <a href="{{ route('admin.kyc') }}" style="height: 40px; padding: 0 20px; border-radius: 10px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; display: inline-flex; align-items: center; text-decoration: none;">
                        Clear
                    </a>
                @endif
            </div>
    ...
    <div style="background: white; border-radius: 14px; padding: 24px; max-width: 400px; width: 90%;">
        ...
        <form method="POST" id="kycForm">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button type="button" onclick="closeKycModal()" style="flex: 1; height: 40px; border-radius: 8px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; border: none;">
                    Cancel
                </button>
            </div>
        </form>
