...
<div class="wrap">
    <div class="whitePanel" style="max-width: 700px; margin: 0 auto;">
        ...
        @if($errors->any())
            <div style="margin: 12px 14px; padding: 12px; background: #dbeafe; border: 1px solid #2563EB; border-radius: 8px;">
        ...
        <form method="POST" action="{{ isset($user) ? route('admin.users.update', $user) : route('admin.users.store') }}" style="padding: 20px;">
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <a href="{{ isset($user) ? route('admin.users.show', $user) : route('admin.users') }}" style="flex: 1; height: 44px; border-radius: 8px; background: #2563EB; color: white; font-size: 13px; font-weight: 900; text-decoration: none; display: flex; align-items: center; justify-content: center;">
                    Cancel
                </a>
            </div>
        </form>
