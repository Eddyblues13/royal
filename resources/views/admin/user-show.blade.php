...
<div class="wrap">
    ...
    @endif
    @if(session('error'))
        <div style="margin-bottom: 12px; padding: 12px; background: #dbeafe; border: 1px solid #2563EB; border-radius: 8px; color: #2563EB; font-size: 12px; font-weight: 700;">
            {{ session('error') }}
        </div>
    @endif
        ...
        <div class="panelHead">
            ...
            <div style="display: flex; gap: 8px;">
                ...
                <form method="POST" action="{{ route('admin.users.delete', $user) }}" style="display: inline;" onsubmit="return confirm('Delete this user? This action cannot be undone.');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" style="padding: 8px 16px; border-radius: 8px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; border: none;">Delete</button>
                </form>
    ...
    <div style="background: white; border-radius: 14px; padding: 24px; max-width: 400px; width: 90%;">
        ...
        <form method="POST" id="balanceForm">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button type="button" onclick="closeBalanceModal()" style="flex: 1; height: 40px; border-radius: 8px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; border: none;">
                    Cancel
                </button>
            </div>
        </form>
    ...
    <div style="background: white; border-radius: 14px; padding: 24px; max-width: 400px; width: 90%;">
        ...
        <form method="POST" id="profitForm">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button type="button" onclick="closeProfitModal()" style="flex: 1; height: 40px; border-radius: 8px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; border: none;">
                    Cancel
                </button>
            </div>
        </form>
    ...
    <div style="background: white; border-radius: 14px; padding: 24px; max-width: 500px; width: 90%;">
        ...
        <form method="POST" id="emailForm">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button type="button" onclick="closeEmailModal()" style="flex: 1; height: 40px; border-radius: 8px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; border: none;">
                    Cancel
                </button>
            </div>
        </form>
