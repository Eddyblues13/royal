...
<div class="wrap">
    ...
    @if($errors->any())
        <div class="alert alert-error" style="background: #dbeafe; color: #1e40af; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #2563EB;">
        ...
        <form method="POST" action="{{ route('admin.payment-settings.update') }}" style="padding: 14px;">
            ...
            <div style="margin-bottom: 16px;">
                <label style="display: block; font-size: 12px; font-weight: 900; color: #111827; margin-bottom: 6px;">
                    Wallet Address <span style="color: #2563EB;">*</span>
                </label>
                <input 
                    type="text" 
    ...
    <div class="whitePanel" style="margin-bottom: 20px;">
        ...
        <form method="POST" action="{{ route('admin.payment-settings.update') }}" style="padding: 14px;">
            ...
            <div style="margin-bottom: 16px;">
                <label style="display: block; font-size: 12px; font-weight: 900; color: #111827; margin-bottom: 6px;">
                    PayPal Email <span style="color: #2563EB;">*</span>
                </label>
                <input 
                    type="email" 
                    name="paypal_email" 
    ...
    <div class="whitePanel" style="margin-bottom: 20px;">
        ...
        <form method="POST" action="{{ route('admin.payment-settings.update') }}" style="padding: 14px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    <label style="display: block; font-size: 12px; font-weight: 900; color: #111827; margin-bottom: 6px;">
                        Bank Name <span style="color: #2563EB;">*</span>
                    </label>
                    <input 
                        type="text" 
                        name="bank_name" 
                ...
                <div>
                    <label style="display: block; font-size: 12px; font-weight: 900; color: #111827; margin-bottom: 6px;">
                        Account Name <span style="color: #2563EB;">*</span>
                    </label>
                    <input 
                        type="text" 
                        name="account_name" 
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                <div>
                    <label style="display: block; font-size: 12px; font-weight: 900; color: #111827; margin-bottom: 6px;">
                        Account Number <span style="color: #2563EB;">*</span>
                    </label>
                    <input 
                        type="text" 
                        name="account_number" 
