...
SWIFT/BIC: ...">{{ old('details', $method->details ?? '') }}</textarea>
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <a href="{{ route('admin.payment-methods') }}" style="flex: 1; height: 44px; border-radius: 8px; background: #2563EB; color: white; font-size: 13px; font-weight: 900; text-decoration: none; display: flex; align-items: center; justify-content: center;">
                    Cancel
                </a>
            </div>
        </form>
