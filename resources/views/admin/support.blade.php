    ...
    <div class="whitePanel" style="margin-bottom: 12px;">
        <form method="GET" action="{{ route('admin.support') }}" class="p-4">
            <div style="display: flex; gap: 12px; align-items: end;">
                ...
                @if(request('status'))
                    <a href="{{ route('admin.support') }}" style="height: 40px; padding: 0 20px; border-radius: 10px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; display: inline-flex; align-items: center; text-decoration: none;">
                        Clear
                    </a>
                @endif
            </div>
    ...
    <div style="background: white; border-radius: 14px; padding: 24px; max-width: 600px; width: 100%; max-height: 90vh; overflow-y: auto;">
        ...
        <form method="POST" id="ticketForm">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button type="button" onclick="closeTicketModal()" style="flex: 1; height: 40px; border-radius: 8px; background: #2563EB; color: white; font-size: 12px; font-weight: 900; cursor: pointer; border: none;">
                    Cancel
                </button>
            </div>
        </form>
