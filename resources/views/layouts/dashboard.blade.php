...
<head>
    ...
    <title>@yield('title', 'Royal Caribbean Investment Dashboard')</title>
...
<body>
    ...
    <div class="app">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="wordmark">
                <img src="{{ asset('images/logo.png') }}" alt="Royal Caribbean Investment Logo" />
            </div>
        ...
        <main class="content">
            ...
            @if(session('error'))
            <div
                style="background: rgba(37, 99, 235, 0.1); border: 1px solid rgba(37, 99, 235, 0.2); color: #60a5fa; padding: 14px 18px; margin: 18px 18px; margin-bottom: 0; border-radius: 12px; display: flex; align-items: center; gap: 12px; font-size: 14px; font-weight: 600;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    style="flex-shrink:0;">
            ...
            @if($errors->any())
            <div
                style="background: rgba(37, 99, 235, 0.1); border: 1px solid rgba(37, 99, 235, 0.2); color: #60a5fa; padding: 14px 18px; margin: 18px 18px; margin-bottom: 0; border-radius: 12px; font-size: 14px; font-weight: 600;">
