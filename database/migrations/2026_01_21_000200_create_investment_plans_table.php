...
return new class extends Migration
{
     ...
     * plan‑specific fields like max_investment, profit_margin,
    ...
    public function up(): void
    {
        Schema::create('investment_plans', function (Blueprint $table) {
            ...
            $table->string('category')->nullable();      // e.g. "Royal Caribbean"
            $table->string('strategy')->nullable();      // e.g. "Royal Caribbean Investment"
