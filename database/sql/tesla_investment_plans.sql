-- Royal Caribbean Investment Plans — schema + seed (SQL)
...
-- ========== SEED: replace plans with 4 Royal Caribbean plans ==========
...
-- Insert the four Royal Caribbean plans
...
('STARTER PLAN', 'starter', 'Royal Caribbean', 'Royal Caribbean Investment', 'medium', 0, 20,
 2000, 9999, 20, 2, '2 days', 1, 1, NOW(), NOW()),

('MEGA PLAN', 'mega', 'Royal Caribbean', 'Royal Caribbean Investment', 'medium', 0, 20,
 10000, 39999, 20, 4, '4 days', 1, 2, NOW(), NOW()),

('GRAND PLAN', 'grand', 'Royal Caribbean', 'Royal Caribbean Investment', 'high', 0, 30,
 40000, 99999, 30, 7, '7 days', 1, 3, NOW(), NOW()),

('VIP PLAN', 'vip', 'Royal Caribbean', 'Royal Caribbean Investment', 'high', 0, 50,
