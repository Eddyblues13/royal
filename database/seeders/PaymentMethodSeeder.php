    ...
    public function run(): void
    {
        $methods = [
            ...
            [
                ...
                'details' => "Bank name: Royal Caribbean Global Bank\nAccount name: Royal Caribbean Investments Ltd\nAccount number: 1234567890\nIBAN: GB00RCIL00000012345678\nSWIFT/BIC: RCILGB2L",
                'display_order' => 5,
            ],
            [
                'name' => 'PayPal',
                ...
                'details' => "PayPal email: payments@royalcaribbeaninvestment.com",
                'display_order' => 6,
            ],
        ];
